...
//     string: ["Frontend Developer", "Java Developer", "Web Developer"],
//     typeSpeed: 100,
//     backSpeed: 100,
//     backDelay: 1000,
//     loop: true
...
const portfolioeBoxs = document.querySelectorAll('.portfolio-box');
...
portfolioLists.forEach((list, idx) => {
    list.addEventListener('click', () => {
        ...
        portfolioeBoxs[idx].classList.add('active');
    });
});
...
var typed = new Typed(".auto-type", {
    strings: ["Frontend Developer", "Java Developer", "Data Analyst / BI Developer"],
    typeSpeed: 100,
    backSpeed: 100,
    loop: true
});
